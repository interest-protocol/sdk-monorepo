...
describe(TickList.name, () => {
  ...
  describe('#nextInitializedTick', () => {
    ...
    it('low - lte = true', () => {
      ...
      }).toThrow('TickList: is below smallest');
    ...
    it('high - lte = false', () => {
      ...
      }).toThrow('Invariant failed: TickList: is at or above largest');
