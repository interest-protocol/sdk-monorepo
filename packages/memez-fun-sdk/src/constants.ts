...
export const PACKAGES = {
  ...
  [Network.MAINNET]: {
    ...
    VESTING: {
      ...
      latest: normalizeSuiAddress(
        '0xc0e8906f5e0dd114d5de1da7cda2ce7d58763b8d9da3af839fbe25e8c106d317'
      ),
    },
    TEST_MEMEZ_MIGRATOR: {
      original: normalizeSuiAddress(
...
export const OWNED_OBJECTS = {
  ...
  [Network.MAINNET]: {
    ...
    MEMEZ_UPGRADE_CAP: normalizeSuiObjectId(
      '0x252b53c8a16c2a8843dd47f4da60a9fe4b47b790bba37dcc388de12948ea8403'
    ),
    XPUMP_MIGRATOR_UPGRADE_CAP: normalizeSuiObjectId(
      '0x32186a566390b462678f4a4204098266e1337b9522ffa4e4d051c22ce1c38900'
    ),
